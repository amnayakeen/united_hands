<?php
    ...
    class Project extends Event{
        ...
        public function displayOngoingProjects(){
            ...
            if($this->rec['type']=="volunteer"){
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM project WHERE start_date<'$today_date' AND end_date>'$today_date'");
                $nor=mysqli_num_rows($query);
                ...
                $org_id=$org_result['organization_id'];
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM project WHERE start_date<'$today_date' AND end_date>'$today_date' AND organization_id='$org_id'");
                $nor=mysqli_num_rows($query);
        ...
        public function displayCompletedProjects(){
            ...
            if($nor==0){
                ...
                While($rec=mysqli_fetch_assoc($query)){
                    ...
                    $project_id=$rec['project_id'];
                    echo("<tr>
                    <th scope='row'>".$rec['name']." $today_date ".$rec['end_date']."</th>
                    <td>".$result['name']."</td>
                    <td><a href='view-reviews.php?get_id=" . $project_id . "&get_user_id=$this->user_id'><button type='button' class='btn btn-primary btn-lg btn-block'>View Review</button></a></td>
                    </tr>");
                }
                echo("
                </tbody>
    ...
    class Training extends Event{
        ...
        public function displayOngoingTrainings(){
            ...
            if($this->rec['type']=="volunteer"){
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM training WHERE start_date<'$today_date' AND end_date>'$today_date'");
                $nor=mysqli_num_rows($query);

                if($nor==0){
                    echo "<div class='container my-3'><h2>No ongoing trainings to be displayed.</h2></div>";
                }
                else{
                    echo("<div class='container my-3'>
                        <div class='row mb-3'>
                ...
                $org_id=$org_result['organization_id'];
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM training WHERE start_date<'$today_date' AND end_date>'$today_date' AND organization_id='$org_id'"); //retrieves only the organizations training
                $nor=mysqli_num_rows($query);
                ...
                if($nor==0){
                    echo "<div class='container my-3'><h2>No Ongoing traings to be displayed.</h2></div>";
                }
                else{
                    echo("<div class='container my-3'>
                        <div class='row mb-3'>
    ...
    class Gathering extends Event{
        ...
        public function displayOngoingGatherings(){
            ...
            if($this->rec['type']=="volunteer"){
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM community_gathering WHERE start_date<'$today_date' AND end_date>'$today_date'");
                $nor=mysqli_num_rows($query);

                if($nor==0){
                    echo "<div class='container my-3'><h2>No Ongoing Gatherings to be displayed.</h2></div>";
                }
                else{
                    echo("<div class='container my-3'>
                        <div class='row mb-3'>
                ...
                $org_id=$org_result['organization_id'];
                $today_date= date('Y-m-d');
                $query=mysqli_query($this->conn,"SELECT * FROM community_gathering WHERE start_date<'$today_date' AND end_date>'$today_date' AND organization_id='$org_id'"); //retrieves only the organizations gathering
                $nor=mysqli_num_rows($query);
