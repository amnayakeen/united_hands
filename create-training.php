<?php
    ...
    echo $starter_code;
    echo("<head><title>Create Training Session</title></head>");
?>
...
<section style="background-color: #eee;">
  <div class="container py-3">
    ...
    <form action="submittrainingsession.php" method="post">
    <div class="card w-75 mb-3">
  <div class="card-body">
    <h2 style="text-align:center;" >Create Training Session</h2>
    <hr>
