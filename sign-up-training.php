<?php
    ...
    if(isset($_GET['get_id'])){
        $training_id = $_GET['get_id'];
        $user_id = $_GET['get_user_id'];
    }
    $query=mysqli_query($volunteer->conn,"SELECT * FROM training WHERE training_id='$training_id'");
                    ...
                    <div class="row g-0">
                        <div class="col-md-12 col-lg-12 d-flex  justify-content-center">
                            ...
                            <form id="eventForm" method="POST" autocomplete="off">
                                ...
                                <span class="h1 fw-bold mb-0">Sign Up for the Training</span>
                                </div>

                                <div class="row mb-3">
                                    <label for="project_name" class="col-sm-2 col-form-label">Training Name</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="project_name" id="project_name" value="<?php echo $name ?>"  disabled>
                                    </div>
                                </div>
                                <fieldset class="row mb-3">
                                    <legend class="col-form-label col-sm-2 pt-0">Are you signing up for this training?</legend>
                                    <div class="col-sm-10">
                                ...
                                <?php
                                    if(isset($_POST['signup'])){
                                        $details=$volunteer->signupTraining($user_id, $training_id, $_POST['yesorno']);
                                    }
                                ?>
