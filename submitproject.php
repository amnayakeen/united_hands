...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO project (organization_id, project_type, name, address, region, start_date, end_date, start_time, end_time, qualification_required, social_outcome, no_of_volunteers_required, objectives)
            VALUES ('$organization_id', '$project_type', '$name', '$address', '$region', '$startdate', '$enddate', '$start_time', '$end_time', '$qualification_required', '$social_outcome', '$no_of_volunteer_required', '$objectives')";
