<?php
    ...
    $header = $code->header();
    echo $starter_code;
    echo("<head><title>Volunteer Registration Complete</title></head>");
                    ...
                    <div class="row g-0">
                        <div class="col-md-12 col-lg-12 d-flex  justify-content-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <h6>You have successfully registered to United Hands. You can now login to your account to explore all the events and be a part of the community!</h6>
                                </div>
