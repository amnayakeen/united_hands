...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO training (organization_id,name, address, start_date, end_date, start_time, end_time, description)
            VALUES ('$organization_id','$name', '$address', '$startdate', '$enddate', '$start_time', '$end_time', '$description')";
    //$sql = "SELECT organization_id FROM orgainzation where user_id = '$userId'";
