...
<div class="container my-5 p-5 container-width">
            <nav>
                ...
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link active" id="nav-gathering-tab" data-bs-toggle="tab" data-bs-target="#nav-gathering"
                    type="submit" role="tab" aria-controls="nav-gathering" aria-selected="true" name="gathering">Community Gathering</button>
                </div>
                </form>

                    <div class="tab-pane fade show show-custom p-3" id="nav-gathering" role="tabpanel" aria-labelledby="nav-gathering-tab">
                        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3"  role="search">
                            <div class="row mb-3">
                                ...
                                <div class="col-1">
                                    <button type="submit" class="btn btn-primary" name="gathering_search">Search</button>
                                </div>
                                </div>
                            <div class="row mb-3">
                        ...
                        <?php
                            $display_gatherings = $gathering->displayUpcomingGatherings();
                        ?>
                    </div>
                </div>
            </nav>
